...
function findTrackByIdentity(value){const key=String(value||"");return state.tracks.find(track=>[track.firestoreId,track.docId,track.documentId,track.id,track.slug,track.legacyId].some(candidate=>String(candidate||"")===key))}
